...
# Core insights:
  ...
  ## 1. Scatter Plot - Correlate the offices longitude and latitude. ⤵️
...
### The visualization highlights that states like California (CA), New York (NY), and Massachusetts (MA) have the highest concentrations of offices. This data can be useful for identifying business hubs, understanding regional economic activity, or making strategic expansion decisions.Analysis centers on examining office distribution across different states in the USA.
 ...
 ![Screenshot (351)](https://github.com/user-attachments/assets/75df6a3a-7a85-4aee-9d8c-2c5912cb08e6)
  ...
  ### Focusing on identifying the distribution of office locations across different countries. The Python script reads data from offices.csv and verifies the presence of the 'country_code' column. It then counts the number of offices per country and visualizes the distribution using a bar chart with plotly.express. The resulting graph highlights the countries with the most office locations, with the USA leading significantly.
...
### Azure Synapse SQL contributing to summarize key insights from your dataset while leveraging SQL queries for analysis. Here’s how you can structure it. Fund creation peaked in certain months, possibly due to economic shifts. California and New York have the highest office concentrations, and Global office distribution highlights business hubs in specific countries.


## 6. Line Chat - finding most payments Cash or Stock.  ⤵️
